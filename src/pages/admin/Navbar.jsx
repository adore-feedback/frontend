    ...
    return (
        <aside id="sidebar-nav" className="h-screen w-64 border-r border-outline-variant/15 bg-surface-container-low sticky top-0 hidden md:flex flex-col p-6 space-y-2">
            <div className="mb-10 px-4">
                ...
                <p className="text-xs text-secondary font-medium tracking-wider uppercase">Form Management</p>
            </div>
            <nav className="flex-1 space-y-1">
                ...
                <Link id="nav-form-creator" className={location.pathname === '/admin/forms/new' ? currentTileStyle : nonCurrentTileStyle} to={'/admin/forms/new'}>
                    <span className="material-symbols-outlined" data-icon="add_circle">add_circle</span>
                    <span>Form Creator</span>
                </Link>
                <Link id="nav-live-forms" className={nonCurrentTileStyle} to={'/admin'}>
